...
print("")
pl.plot(distanceVariation, np.asarray(rateVariationCell) / 1e6)
pl.plot(distanceVariation, np.asarray(rateVariationD2d) / 1e6)
pl.plot(distanceVariation, np.asarray(rateVariationBoth) / 1e6)
pl.xlabel("Distance between D2D Users (m)")
